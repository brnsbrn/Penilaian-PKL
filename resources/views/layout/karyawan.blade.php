...
<head>
  ...
  <title>Penilaian Pelajar PKL</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link">Selamat datang di halaman  {{ session('role')}}</a>
      </li>
    </ul>

    <ul class="navbar-nav ml-auto">
      <a href='/logout'><button type="button" class="btn btn-primary center"><i class="fa-solid fa-right-from-bracket"></i>  Logout</button></a>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Penilaian PKL</span>
    </a>
